...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::put('/receptionists/schedules/update/{id}', [ScheduleController::class, 'updateSchedule']);
    ...
    Route::put('/doctors/schedules/{id}', [ScheduleController::class, 'updateSchedule']);
